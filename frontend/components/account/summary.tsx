    ...
    <div className='flex flex-col sm:flex-row justify-between rounded-lg bg-stone-950  p-4 mb-8'>
          <div className={``}>
            <div className='text-5xl font-semibold mb-4'>
              {user?.telosBalance} <span className='uppercase text-sm'>tlos</span>
            </div>
          ...
          <div className='flex sm:block'>
            <div className={`mb-4 mr-8 sm:mr-0 `}>
              <div className='text-3xl font-semibold'>
                {user?.rewardsEarned} <span className='uppercase text-sm'>pgy</span>
              </div>
            ...
            <div className={``}>
              <div className='text-lg font-semibold'>
                {user?.timeSaved}/{user?.telosDuration} days left.
              </div>
              <div className='uppercase text-[10px]'>rewards earned</div>
            </div>
          </div>
